...
/* harmony import */ var _components_Blog_blog_item_blog_item_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./components/Blog/blog-item/blog-item.component */ "./src/app/components/Blog/blog-item/blog-item.component.ts");
/* harmony import */ var _components_Blog_blog_item_text_blog_item_text_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/Blog/blog-item-text/blog-item-text.component */ "./src/app/components/Blog/blog-item-text/blog-item-text.component.ts");
/* harmony import */ var _components_Blog_blog_item_image_blog_item_image_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./components/Blog/blog-item-image/blog-item-image.component */ "./src/app/components/Blog/blog-item-image/blog-item-image.component.ts");
...
/* harmony import */ var _Directives_text_format_directive__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Directives/text-format.directive */ "./src/app/Directives/text-format.directive.ts");
/* harmony import */ var _services_data_service_service__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./services/data-service.service */ "./src/app/services/data-service.service.ts");
/* harmony import */ var _components_blog_blog_details_blog_details_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./components/blog/blog-details/blog-details.component */ "./src/app/components/blog/blog-details/blog-details.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _components_Blog_blog_item_blog_item_component__WEBPACK_IMPORTED_MODULE_8__["BlogItemComponent"],
                _components_Blog_blog_item_text_blog_item_text_component__WEBPACK_IMPORTED_MODULE_9__["BlogItemTextComponent"],
                _components_Blog_blog_item_image_blog_item_image_component__WEBPACK_IMPORTED_MODULE_10__["BlogItemImageComponent"],
                _components_blog_blog_details_blog_details_component__WEBPACK_IMPORTED_MODULE_19__["BlogDetailsComponent"],
                ...
                _Directives_text_format_directive__WEBPACK_IMPORTED_MODULE_17__["TextFormatDirective"],
            ],
            imports: [
            ...
            providers: [_services_data_service_service__WEBPACK_IMPORTED_MODULE_18__["DataServiceService"]],
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _components_quiz_quiz_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/quiz/quiz.component */ "./src/app/components/quiz/quiz.component.ts");
...
/* harmony import */ var _components_home_home_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/home/home.component */ "./src/app/components/home/home.component.ts");
/* harmony import */ var _components_blog_blog_details_blog_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/blog/blog-details/blog-details.component */ "./src/app/components/blog/blog-details/blog-details.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var appRoutes = [
    ...
    {
        path: 'quiz',
        component: _components_quiz_quiz_component__WEBPACK_IMPORTED_MODULE_2__["QuizComponent"],
    },
    {
        path: 'blog',
    ...
    },
    {
        ...
        component: _components_blog_blog_details_blog_details_component__WEBPACK_IMPORTED_MODULE_6__["BlogDetailsComponent"],
    }
];
...
var BlogItemComponent = /** @class */ (function () {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], BlogItemComponent.prototype, "content", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
    ], BlogItemComponent.prototype, "url", void 0);
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])(),
        __metadata("design:type", String)
...
var BlogDetailsComponent = /** @class */ (function () {
    function BlogDetailsComponent(route, DataServiceService) {
        this.route = route;
        this.DataServiceService = DataServiceService;
    }
    BlogDetailsComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.DataServiceService.getPost(this.route.params['id']).subscribe(function (data) {
            _this.post = data;
        });
    };
...
var BlogComponent = /** @class */ (function () {
    function BlogComponent(dataServiceService) {
        var _this = this;
        this.dataServiceService = dataServiceService;
        this.dataServiceService.getAll().subscribe(function (results) {
            _this.list = results;
        });
    }
...
var DataServiceService = /** @class */ (function () {
    ...
    DataServiceService.prototype.getAll = function () {
        return this.http.get(this.url + 'api/posts').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (x) { return x.slice(0, 20); }));
    };
    DataServiceService.prototype.getPost = function (id) {
...
module.exports = __webpack_require__(/*! C:\Users\student\Desktop\Nowy folder (3)\TAI_L8_zaliczenie\src\main.ts */"./src/main.ts");
